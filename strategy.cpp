...
void Strategy::classifyByHV(const vector<Vec4f>& lines, QVector<QLineF> &allHLines, QVector<QLineF> &allVLines)
{
...
void Strategy::parseHLines(const QVector<QLineF> &hlines, bool regularLine)
{
...
void Strategy::parseVLines(const QVector<QLineF> &vlines, bool regularLine)
{
...
void Strategy::closeHLineByVLine(const QVector<QLineF> &hlines, const QVector<QLineF> &vlines)
{
...
void Strategy::closeVLineByHLine(const QVector<QLineF> &hlines, const QVector<QLineF> &vlines)
{
    for (const QLineF& vline: vlines) {
